...
{
	//빛의 방향과 픽셀의 노말값의 내적으로 빛의 세기를 계산
					...
					float4 vEyeDir)
{
	...
	//빛의 세기를 계산하고 0~1값으로 만들어준다음 반사지수 vEyeDir.w 값으로 거듭제곱 해준다
