...
void myMatrix::InverseGaussJordan(float* m, float *out)
{
	double a[4][8];
	int numrow = 4;
...
myMatrix  myMatrix::InverseGeneral(float *out)
{
	myMatrix matInverse;
	float det;
...
myMatrix  myMatrix::Inverse(float *out)
{
	myMatrix matInverse;
	float det;
	float tmp[16]; /* Allow out == in. */
