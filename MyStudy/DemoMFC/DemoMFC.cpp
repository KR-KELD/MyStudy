...
// DemoMFC.cpp: 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BOOL CDemoMFCApp::InitInstance()
{
	...
	CDemoMFCView* pView = (CDemoMFCView*)pFrame->GetActiveView();
...
BOOL CDemoMFCApp::OnIdle(LONG lCount)
{
